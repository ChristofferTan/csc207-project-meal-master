...
public class AddFavoriteRecipeInteractorTest {
    ...
    void SuccessTest() {
        ...
        AddFavoriteRecipeInputData inputData = new AddFavoriteRecipeInputData("Christoffer", recipe);
        ...
        AddFavoriteRecipeInputBoundary interactor = new AddFavoriteRecipeInteractor(userDAO, successPresenter);
